...
public class Main_productos_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_productos_);
        inicializar();
        listarClientes();
    ...
    private void listarClientes(){
        referenciaClientes.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new ClienteAdapter(list, Main_productos_Activity.this);
                lv_listar_lista.setAdapter(adapter);
            }

            @Override
            public void onCancelled(DatabaseError error) {
                Toast.makeText(Main_productos_Activity.this, "Error: " + error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }

    private void clickItem(ClienteModel model){
        Toast.makeText(this, "Usted Eligio el producto " + model.get_nombre(), Toast.LENGTH_LONG).show();
